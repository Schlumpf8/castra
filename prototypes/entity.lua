...
local function createDataCollectorSpawn(item_name, icon)
    return {
        ...
        icons =
        {
            ...
            {
                icon = "__castra-prime-assets__/graphics/fusion-reactor/fusion-reactor-icon.png",
                scale = 0.7,
                shift = { 0, -10 }
            },
            {
...
data:extend({
    {
        ...
        name = "forge",
        icon = "__castra-prime-assets__/graphics/atom-forge/atom-forge-icon.png",
        icon_size = 64,
        ...
        graphics_set = {
            animation = {
                layers = {
                    {
                        filename = "__castra-prime-assets__/graphics/atom-forge/atom-forge-hr-shadow.png",
                        priority = "high",
                        width = 900,
                        height = 500,
                        frame_count = 1,
                    ...
                    },
                    {
                        ...
                        animation_speed = 0.3,
                        scale = 0.5,
                        filename = "__castra-prime-assets__/graphics/atom-forge/atom-forge-hr-animation-1.png",
                        frame_count = 64,
                        line_length = 8,
                        shift = { 0, -1 }
                    },
            ...
            animations = {
                {
                    layers = {
                        {
                            filename = "__castra-prime-assets__/graphics/fusion-reactor/fusion-reactor-hr-shadow.png",
                            priority = "high",
                            width = 700,
                            height = 600,
                            frame_count = 1,
                        ...
                        },
                        {
                            ...
                            scale = 0.5,
                            filename =
                            "__castra-prime-assets__/graphics/fusion-reactor/fusion-reactor-hr-animation.png",
                            frame_count = 60,
                            line_length = 8
                        },
                        {
                            ...
                            scale = 0.5,
                            filename =
                            "__castra-prime-assets__/graphics/fusion-reactor/fusion-reactor-hr-animation-emission.png",
                            frame_count = 60,
                            line_length = 8,
                            draw_as_glow = true,
                            blend_mode = "additive"
    ...
    createDataCollectorSpawn("millerite", "__castra-prime-assets__/graphics/icons/millerite.png"),
    createDataCollectorSpawn("gunpowder", "__castra-prime-assets__/graphics/icons/gunpowder.png"),
    ...
    createDataCollectorSpawn("castra-data", "__castra-prime-assets__/graphics/icons/castra-data.png"),
    {
        -- combat-roboport
        type = "container",
        name = "combat-roboport",
        icon = "__castra-prime-assets__/graphics/icons/combat-roboport.png",
        ...
        picture = {
            layers = {
                ...
                },
                {
                    ...
                    scale = 0.5,
                    filename =
                    "__castra-prime-assets__/graphics/entity/combat-roboport/combat-roboport-hr-animation-emission.png",
                    frame_count = 60,
                    line_length = 8,
                    draw_as_glow = true,
                    blend_mode = "additive"
